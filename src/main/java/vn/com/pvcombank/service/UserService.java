...
public class UserService {
    ...
    @Transactional(readOnly = true)
    public Optional<User> getUserWithAuthoritiesByUserId(String userId) {
        return userRepository.findOneWithAuthoritiesByLogin(userId);
    }
    ...
    public AdminUserDTO getUserFromAuthentication(AbstractAuthenticationToken authToken) {
        ...
        User localUser = userRepository.findOneWithAuthoritiesByLogin(user.getLogin()).orElse(new User());

        // Set<Authority> authorities = new HashSet<>();
        user.setActivated(localUser.isActivated());
        user.setAuthorities(localUser.getAuthorities());
